...
import { payMethod, payStatus, purchasesStatus } from 'src/constants/purchase'
...
export default function PurchaseDetail() {
  ...
  return (
    <div className='md:pb-30 rounded-sm bg-white px-2 pb-10 shadow md:px-7'>
        ...
        <div className='mt-8 flex md:flex-row md:items-start'>
          <div className='mt-6 flex-grow md:mt-0 md:pr-12'>
            <div className='flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>ID hóa đơn</div>
              <div className='sm:w-[70%] sm:pl-5'>
                <div className='pt-3 text-lg text-gray-900'>{purchaseDetail.orderId}</div>
              </div>
            </div>

            <div className='flex flex-col flex-wrap sm:flex-row'>
              <div className='pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Ngày lập đơn hàng</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='flex flex-col flex-wrap sm:flex-row'>
              <div className='pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Phương thức thanh toán</div>
              <div className='sm:w-[70%] sm:pl-5'>
                <div className='flex pt-3 text-lg capitalize text-gray-900'>
                  {purchaseDetail.payMethod === payMethod.byCash
            ...
            <div className='flex flex-col flex-wrap sm:flex-row'>
              <div className='pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Thanh toán</div>
              <div className='sm:w-[70%] sm:pl-5'>
                <div className='flex pt-3 text-lg capitalize text-gray-900'>
                  {purchaseDetail.paymentStatus === payStatus.PAID ? 'Đã thanh toán' : 'Chưa thanh toán'}
                </div>
              </div>
            </div>

            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Trạng thái</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Tên khách hàng</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Email</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Địa chỉ</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>SĐT</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Tên sản phẩm</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Ảnh</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Số lượng</div>
              <div className='sm:w-[70%] sm:pl-5'>
            ...
            <div className='mt-2 flex flex-col flex-wrap sm:flex-row'>
              <div className='truncate pt-3 text-lg capitalize sm:w-[30%] sm:text-right'>Thành tiền</div>
              <div className='sm:w-[70%] sm:pl-5'>
