...
interface Props {
  activeChangeLang?: boolean
}

export default function NavHeader({ activeChangeLang = true }: Props) {
      ...
      {isAuthenticated && (
        <Popover
          ...
          renderPopover={
            <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
              <Link
                to={path.profile}
                className='block w-full bg-white px-4
        py-3 text-left hover:bg-slate-100 hover:text-orange'
              >
                {t('my account')}
              </Link>
        ...
        py-3 text-left hover:bg-slate-100 hover:text-orange'
              ...
              <Link
                ...
                className='block w-full bg-white px-4 py-3
        text-left  hover:bg-slate-100 hover:text-orange'
              >
                {t('purchase order')}
              </Link>
              <button
