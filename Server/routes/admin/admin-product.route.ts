...
adminProductRouter.get(
  ...
  authMiddleware.verifyAccessToken,
  authMiddleware.verifyAdmin,
  wrapAsync(ProductController.getProductImg)
)
adminProductRouter.delete(
  '/delete/image/:product_id',
  authMiddleware.verifyAccessToken,
  authMiddleware.verifyAdmin,
  wrapAsync(ProductController.deleteProductImg)
)
adminProductRouter.delete(
  '/delete/images/:product_id',
  authMiddleware.verifyAccessToken,
  authMiddleware.verifyAdmin,
  wrapAsync(ProductController.deleteProductImgs)
)
